...
export class ProjectComponent implements OnInit {
    ...
    loadRootNodeOnAdd() {
        ...
        if (rd.length === 1) {
            ...
            item.projectId = this.projectDetails.projectId
            item.reportingToId = null;
            item.profileUrl = "assets/layout/images/default_icon_employee.jpg";
            item.projectDescription = this.projectDetails.description
            item.projectName = this.projectDetails.name
            item.clientName = this.projectDetails.clientName
            item.clientCompanyName = this.projectDetails.companyName
