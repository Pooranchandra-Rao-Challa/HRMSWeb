...
import { CREATE_BANK_DETAILS_URI, CREATE_BASIC_DETAILS_URI, GET_EMPLOYEES_URI, GET_EMPLOYEE_BASED_ON_ID_URI, GET_OFFICE_DETAILS_URI } from './api.uri.service';
import { BankDetailDto, EmployeeBasicDetailDto, EmployeeBasicDetailViewDto, EmployeeOfficedetailsviewDto, EmployeesViewDto } from '../_models/employes';
