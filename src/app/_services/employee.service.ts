...
import {
  CREATE_ADDRESS_URI, CREATE_BANK_DETAILS_URI, CREATE_BASIC_DETAILS_URI, CREATE_DOCUMENTS_URI, CREATE_EXPERIENCE_URI, CREATE_FAMILY_DETAILS_URI, ENROLL_URI, GET_ADDRESS_BASED_ON_ID_URI, GET_BANKDETAILS_URI,
  GET_COUNTRIES_URI,
  GET_DESIGNATION_URI,
...
import { AddressDetailsDto, BankDetailsDto, Countries, Designation, EmployeAdressViewDto, EmployeeBasicDetailDto, EmployeeBasicDetailViewDto, EmployeeOfficedetailsDto, EmployeeOfficedetailsviewDto, EmployeesViewDto, ExperienceDetailsDto, FamilyDetailsDto, SkillArea, States, UploadDocuments } from '../_models/employes';
